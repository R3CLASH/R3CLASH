...
//Taking Client ID and the Client Secret as the input to authenicate the use account
function onPageLoad(){
...
//Redirect back to redirect_uri with the code
...
//assigning the Client ID and the Secret for the respective variable for authorization
...
//getting the Refresh Access Token
...
//setting up the access and refresh tokens to connect with the API
...
//Calling the PLAYLISTS endpoint
...
//Calling the SHUFFLE endpoint
function shuffle(){
    callApi( "PUT", SHUFFLE + "?state=true&device_id=" + deviceId(), null, handleApiResponse );
    play(); 
}

//Calling the PAUSE endpoint
function pause(){
